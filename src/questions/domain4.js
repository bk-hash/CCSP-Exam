const questions = [
  ...
  // --- Appended Domain 4 questions from user ---
  {
  ...
  ,
  // --- Appended Domain 4 questions from user (starting from #6) ---
  {
  ...
  // ...additional questions from user (7–110) would be appended here in the same format...
  {
  ...
  },
  {
    ...
    options: ["A. Inversion", "B. Spoofing", "C. Repudiation", "D. Escalation of privilege"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. Users are constantly trying to break the security of your environment", "B. APIs can’t ever be secure", "C. Hackers are constantly infiltrating all APIs", "D. Users enhance their productivity however they can"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. Young programmers are not nearly as disciplined in their coding practices as older programmers", "B. Some current programmers don’t write code line by line and instead use code component libraries", "C. Coding languages have not been secure for 20 years", "D. Users are not clear in defining their requirements at the outset of the software development lifecycle (SDLC)"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Open source", "B. Proprietary/internal", "C. Neither open source nor proprietary", "D. Combination of open source and proprietary"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. Code verification/code implementation", "B. Identity validation/access permission", "C. Inverse incantation/obverse instantiation", "D. User access/privileged access"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Regulatory mandates", "B. Business needs and acceptable risk", "C. User requirements and management requests", "D. Optimum performance and security provision"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. The cloud provider", "B. Senior management", "C. Data owners", "D. System administrators"],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. WS-Federation", "B. OpenID", "C. OAuth (Open Authorization)", "D. Pretty Good Privacy (PGP)"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. WS-Federation", "B. OpenID Connect", "C. Service Organization Control (SOC) 2", "D. Open Web Application Security Project (OWASP)"],
    correctAnswer: "B",
  ...
  // ...additional questions from user would be appended here...
  {
    question: "Authentication mechanisms typically include any or all of the following except ___.",
    options: ["A. Something you know", "B. Someone you know", "C. Something you have", "D. Something you are"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Using an automated teller machine (ATM) to get cash with your credit or debit card", "B. Using a password and personal identification number (PIN) to log into a website", "C. Presenting a voice sample and fingerprint to access a secure facility", "D. Displaying a birth certificate and a credit card"],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. In every IT transaction", "B. For high-risk operations and data that is particularly sensitive", "C. When remote users are logging into the cloud environment", "D. Only in the traditional environment"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Malicious", "B. Simple Mail Transfer Protocol (SMTP)", "C. Internet Control Message Protocol (ICMP)", "D. Hypertext Transfer Protocol (HTTP)"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. Social engineering", "B. Physical theft", "C. Obverse inflection", "D. Cross-site scripting"],
    correctAnswer: "D",
  ...
  },
  {
    ...
    options: ["A. SQL injection", "B. Cross-site scripting", "C. Insecure direct-object reference", "D. Social engineering"],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: ["A. Web application firewall (WAF)", "B. Database activity monitor (DAM)", "C. Extensible Markup Language (XML) gateway", "D. Single sign-on (SSO)"],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. Extensible Markup Language (XML) gateway", "B. Application programming interface (API) gateway", "C. Web application firewall (WAF)", "D. Database activity monitor (DAM)"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Known past behavior in the environment", "B. Identity of the malicious user", "C. Point of origination", "D. Signature matching"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Privacy, security", "B. Security, optimization", "C. Privacy, integrity", "D. Enhancement, privacy"],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. Symmetric key", "B. Asymmetric key", "C. Public-private key pair", "D. Inverse comparison"],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: ["A. Securing each end of a client-server connection", "B. Creating an encrypted tunnel between two endpoints", "C. Encrypting databases", "D. Restricting key access to only eight parties"],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: ["A. Having the developers review the code", "B. Having the developers perform dynamic testing", "C. Using automated agents to perform dynamic testing", "D. Social engineering"],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. They are notoriously bad, as a group, at testing.", "B. They work for the same department as the testing personnel.", "C. They have a vested interest in having the software perform well.", "D. They are never trained on testing procedures."],
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: ["A. Optimizing the production environment by moving processes that are not frequently used into the sandbox", "B. Allowing secure remote access for users who need resources in the cloud environment", "C. Running malware for analysis purposes", "D. Creating secure subnets of the production environment"],
    correctAnswer: "C",
  ...
  {
    question: "Sandboxing can often be used for ___.",
    options: ["A. Testing user awareness and training", "B. Testing security response capabilities", "C. Testing software before putting it into production", "D. Testing regulatory response to new configurations and modifications"],
    correctAnswer: "C",
    explanation: "Sandboxing is used for pre-production software testing.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    ...
    options: ["A. Running an application in a non-native environment", "B. Installing updates to a system’s operating system (OS)", "C. Preventing escalation of privilege by untrusted users", "D. Enhancing performance of systems"],
    correctAnswer: "A",
  ...
  {
    question: "Application virtualization can typically be used for ___.",
    options: ["A. Denying access to untrusted users", "B. Detecting and mitigating distributed denial of service (DDoS) attacks", "C. Replacing encryption as a necessary control", "D. Running an application on an endpoint without installing it"],
    correctAnswer: "D",
    explanation: "Virtualization allows running apps without installation.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Software developers designing applications for the cloud should expect to include options to ensure all of the following capabilities except ___.",
    options: ["A. Encryption of data at rest", "B. Encryption of data in transit", "C. Data masking", "D. Hashing database fields"],
    correctAnswer: "D",
  ...
  {
    question: "In a platform as a service (PaaS) model, who should most likely be responsible for the security of the applications in the production environment?",
    options: ["A. Cloud customer", "B. Cloud provider", "C. Regulator", "D. Programmers"],
    correctAnswer: "A",
    explanation: "Cloud customers are responsible for app security in PaaS.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "In the testing phase of the software development lifecycle (SDLC), software performance and ___ should both be reviewed.",
    options: ["A. Quality", "B. Brevity", "C. Requirements", "D. Security"],
    correctAnswer: "D",
    explanation: "Security and performance are both reviewed in SDLC testing.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Regardless of which model the organization uses for system development, in which phase of the software development lifecycle (SDLC) will user input be requested and considered?",
    options: ["A. Define", "B. Design", "C. Develop", "D. Detect"],
    correctAnswer: "A",
    explanation: "User input is requested in the Define phase.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Which phase of the software development lifecycle (SDLC) is most likely to involve crypto-shredding?",
    options: ["A. Define", "B. Design", "C. Test", "D. Disposal"],
    correctAnswer: "D",
    explanation: "Crypto-shredding is most likely in the Disposal phase.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
  ...
  {
    question: "Where are business requirements most likely to be mapped to software construction?",
    options: ["A. Define", "B. Design", "C. Test", "D. Secure Operations"],
    correctAnswer: "B",
    explanation: "Business requirements are mapped in the Design phase.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
  ...
  {
    question: "All of the following are usually nonfunctional requirements except ___.",
    options: ["A. Color", "B. Sound", "C. Security", "D. Function"],
    correctAnswer: "D",
    explanation: "Function is a functional requirement.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "easy"
  },
  // ...continue with additional questions from user batch...
  {
    question: "RESTful responses can come from the server in ___ or ___ formats.",
    options: ["A. Extensible Markup Language (XML), JavaScript Open Notation (JSON)", "B. Hypertext Transfer Protocol (HTTP), X.509", "C. American Standard Code for Information Interchange (ASCII), text", "D. Hypertext Markup Language (HTML), Extensible Markup Language (XML)"],
    correctAnswer: "A",
    explanation: "RESTful responses are typically in XML or JSON formats.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Which of the following is an informal industry term for moving applications from a traditional environment into the cloud?",
    options: ["A. Instantiation", "B. Porting", "C. Grandslamming", "D. Forklifting"],
    correctAnswer: "D",
    explanation: "'Forklifting' is the informal term for moving apps to the cloud.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Developers creating software for the cloud environment should bear in mind cloud-specific risks such as ___ and ___.",
    options: ["A. DoS and DDoS (denial of service and distributed denial of service)", "B. Multitenancy and third-party administrators", "C. Unprotected servers and unprotected clients", "D. Default configurations and user error"],
    correctAnswer: "A",
    explanation: "DoS and DDoS are key cloud-specific risks.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "When an organization considers cloud migrations, the organization’s software developers will need to know which ___ and which ___ the organization will be using, in order to properly and securely create suitable applications.",
    options: ["A. Geographic location, native language", "B. Legal restrictions, specific ISP", "C. Service model, deployment model", "D. Available bandwidth, telecommunications country code"],
    correctAnswer: "C",
    explanation: "Service and deployment models are essential for secure cloud migration.",
    domain: "Cloud Application Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  {
    question: "Which of the following is perhaps the best method for reducing the risk of a specific application not delivering the proper level of functionality and performance when it is moved from the traditional environment into the cloud?",
    options: ["A. Remove the application from the organization’s production environment and replace it with something else.", "B. Negotiate and conduct a trial run in the cloud environment for that application before permanently migrating.", "C. Make sure the application is fully updated and patched according to all vendor specifications.", "D. Run the application in an emulator."],
    correctAnswer: "B",
