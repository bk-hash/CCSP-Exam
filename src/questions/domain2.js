const questions = [
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Mapping to existing ACLs is a characteristic of DRM solutions.",
    domain: "Cloud Data Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  ...
  },
  {
    ...
    correctAnswer: "D",
    explanation: "Stateful inspection is a common function in egress monitoring solutions.",
    domain: "Cloud Data Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Persistence is a key characteristic of DRM solutions.",
    domain: "Cloud Data Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  // --- Appended Domain 2 questions from user (tracking: 38–50) ---
  {
    question: "DLP (data loss prevention or data leak protection) solutions may use all of the following techniques to identify sensitive data except...",
    options: [
      "A. Pattern matching",
  ...
  // --- Appended Domain 2 questions from user (tracking: 51–150) ---
  {
  ...
  // --- Appended Domain 2 questions from user (tracking: 57–80) ---
  {
  ...
  },
  {
    ...
    correctAnswer: "A",
    explanation: "Bit-splitting may require trust in additional third parties beyond the primary cloud provider.",
    domain: "Cloud Data Security",
    type: "multiple-choice",
    difficulty: "medium"
  },
  ...
  ,
  // --- Appended Domain 2 questions from user (tracking: 101–120) ---
  {
  ...
  ,
  // --- Appended Domain 2 questions from user (tracking: 81–100) ---
  {
    question: "Which of the following is a possible negative aspect of bit-splitting?",
    options: [
      "A. It may require trust in additional third parties beyond the primary cloud service provider.",
  ...
  // ...continue appending questions 81–150 in next batches...
];
