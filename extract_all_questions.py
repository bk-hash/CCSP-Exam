...
def extract_questions_from_js_robust(file_path):
    """Extract questions array from JavaScript file using AST parsing"""
    ...
    try:
        # Use literal_eval to safely parse the JavaScript array as Python
...
def main():
    ...
    for i, file_path in enumerate(domain_files, 1):
        ...
        questions = extract_questions_from_js_robust(file_path)
